        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="prose prose-invert max-w-none">
              ...
              {/* Interactive Element */}
              <div className="mt-8 p-6 rounded-xl" style={{ backgroundColor: `${planet.color}20` }}>
                <h3 className="text-xl font-semibold mb-4">Interactive Experience</h3>
                <p className="mb-4">
                  {id === 'frontend' && 'Try dragging these UI components to see them in action!'}
                  {id === 'ai' && 'Ask me anything about AI and I\'ll do my best to help!'}
                  {id === 'projects' && 'Browse through my projects and see them in action.'}
                  {id === 'about' && 'Take a quiz to test how well you know me!'}
                </p>
