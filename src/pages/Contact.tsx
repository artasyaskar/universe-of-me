    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white p-6">
      <div className="max-w-3xl mx-auto py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-300">Get in touch for any questions or opportunities</p>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-semibold mb-6 text-blue-400">Or reach out directly</h2>
